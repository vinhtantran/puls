...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/vinhtantran/puls.svg?branch=master)](https://travis-ci.org/vinhtantran/puls)
...
[![Codecov test coverage](https://codecov.io/gh/vinhtantran/puls/branch/master/graph/badge.svg)](https://codecov.io/gh/vinhtantran/puls?branch=master)
